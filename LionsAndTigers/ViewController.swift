...
//  LionsAndTigers
//
//  Created by GEST Precision on 2/5/15.
...
//    Empty array exists - allows to be used in other functions
    var myTigers:[Tiger] = []
    var lions:[Lion] = []
    
    // You could use the super class in this array also.  best practices for programming arrays.
